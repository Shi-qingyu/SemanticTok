...
class DeAE(nn.Module):
    """
    l-DeAE: latent denoising makes good visual tokenizers.
    """
    ...
    def __init__(
        ...
        params_M = sum(p.numel() for p in self.parameters() if p.requires_grad) / 1e6
        logger.info(f"[DeAE] params: {params_M:.2f}M")
    ...
    def encode(self, x: Tensor, noise_level: float = -1.0):
        ...
        if self.training and self.gamma > 0.0:
            ...
            if self.use_additive_noise:
                z = z + noise_level_tensor * noise
            else:
                z = (1 - noise_level_tensor) * z + noise_level_tensor * noise
...
def deae_SS(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="small", vit_dec_model_size="small", **kwargs)


def deae_SB(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="small", vit_dec_model_size="base", **kwargs)


def deae_SL(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="small", vit_dec_model_size="large", **kwargs)


def deae_BS(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="base", vit_dec_model_size="small", **kwargs)


def deae_BB(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="base", vit_dec_model_size="base", **kwargs)


def deae_BL(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="base", vit_dec_model_size="large", **kwargs)


def deae_LS(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="large", vit_dec_model_size="small", **kwargs)


def deae_LB(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="large", vit_dec_model_size="base", **kwargs)


def deae_LL(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="large", vit_dec_model_size="large", **kwargs)


def deae_XLXL(**kwargs) -> DeAE:
    return DeAE(vit_enc_model_size="xl", vit_dec_model_size="xl", **kwargs)
